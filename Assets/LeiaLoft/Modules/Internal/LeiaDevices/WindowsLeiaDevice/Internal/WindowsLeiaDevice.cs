...
namespace LeiaLoft
{
    ...
    public class WindowsLeiaDevice : AbstractLeiaDevice
    {
        ...
        private DisplayConfig GetBoardDisplayConfig()
        {
            ...
            _displayConfig.ConvergenceDistance = paramsWrapper.GetValue<float>("getConvergenceDistance");
            ...
            _displayConfig.DotPitchInMm = (XyPair<float>)paramsWrapper.Get1DArray<float>("getDotPitchInMm", xyPairLen);
            ...
            double versionNum = _displayConfig.InterlacingMatrix[0];

            Debug.Log("_displayConfig versionNum = "+versionNum);
            ...
            else if (_displayConfig.ActCoefficients.y[0] >= 1000.0)
            {
                ...
                if (_displayConfig.ActCoefficients.y[5] > 0.0)
                ...
                float du = _displayConfig.DotPitchInMm.x / _displayConfig.p_over_du;
