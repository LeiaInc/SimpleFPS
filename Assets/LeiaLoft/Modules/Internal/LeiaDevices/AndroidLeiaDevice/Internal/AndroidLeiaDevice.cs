    ...
    public class AndroidLeiaDevice : AbstractLeiaDevice
    {
        ...
        public override DisplayConfig GetDisplayConfig()
        {
            ...
            catch (System.Exception e)
            {
                ...
                _displayConfig.isSlanted = true;
                _displayConfig.isSquare = false;
                _displayConfig.DotPitchInMm = new XyPair<float>(.10389f,.10389f);
        ...
        private DisplayConfig GetDisplayConfig_LP1_DCv2()
        {
            ...
            _displayConfig.DotPitchInMm = new XyPair<float>(0.10389f, 0.10389f);
            ...
            _displayConfig.UserAlignmentOffset = _displayConfig.AlignmentOffset;
            _displayConfig.UserDisplaySizeInMm = _displayConfig.DisplaySizeInMm;
            _displayConfig.UserDotPitchInMM = _displayConfig.DotPitchInMm;
            ...
            _displayConfig.ConvergenceDistance = 600f;
        ...
        private DisplayConfig GetDisplayConfigFromJson()
        {
            ...
            // TODO: validate
            displayConfig.DotPitchInMm = new XyPair<float>(displayConfigJson.displayGeometry.pixelPitch, displayConfigJson.displayGeometry.pixelPitch);
            ...
            displayConfig.UserAlignmentOffset = displayConfig.AlignmentOffset;
            displayConfig.UserDisplaySizeInMm = displayConfig.DisplaySizeInMm;
            displayConfig.UserDotPitchInMM = displayConfig.DotPitchInMm;
            ...
            displayConfig.ConvergenceDistance = 600f; // Is not it depends on faceZ?
