...
float4 sample_view(float2 uv, int view) {
        ...
        if (rainbowViews > 0.5) {
            ...
            {
            if (view == 0) return tex2D(_MainTex, float2(0.000, 0.66) + float2(0.333, 0.333) * uv.xy);
            else if (view == 1) return tex2D(_MainTex, float2(0.333, 0.66) + float2(0.333, 0.333) * uv.xy);
            else if (view == 2) return tex2D(_MainTex, float2(0.666, 0.66) + float2(0.333, 0.333) * uv.xy);

            else if (view == 3) return tex2D(_MainTex, float2(0.000, 0.333) + float2(0.333, 0.333) * uv.xy);
            else if (view == 4) return tex2D(_MainTex, float2(0.333, 0.333) + float2(0.333, 0.333) * uv.xy);
            else if (view == 5) return tex2D(_MainTex, float2(0.666, 0.333) + float2(0.333, 0.333) * uv.xy);

            else if (view == 6) return tex2D(_MainTex, float2(0.000, 0.00) + float2(0.333, 0.333) * uv.xy);
            else if (view == 7) return tex2D(_MainTex, float2(0.333, 0.00) + float2(0.333, 0.333) * uv.xy);
            else if (view == 8) return tex2D(_MainTex, float2(0.666, 0.00) + float2(0.333, 0.333) * uv.xy);
            }
            else
            {
            // top row, 3 cols
            if (view == 0) return tex2D(_MainTex, float2(0.000,0.75) + float2(0.333, 0.25) * uv.xy);
            else if (view == 1) return tex2D(_MainTex, float2(0.333,0.75) + float2(0.333, 0.25) * uv.xy);
            else if (view == 2) return tex2D(_MainTex, float2(0.666,0.75) + float2(0.333, 0.25) * uv.xy);

            else if (view == 3) return tex2D(_MainTex, float2(0.000,0.50) + float2(0.333, 0.25) * uv.xy);
            else if (view == 4) return tex2D(_MainTex, float2(0.333,0.50) + float2(0.333, 0.25) * uv.xy);
            else if (view == 5) return tex2D(_MainTex, float2(0.666,0.50) + float2(0.333, 0.25) * uv.xy);

            else if (view == 6) return tex2D(_MainTex, float2(0.000,0.25) + float2(0.333, 0.25) * uv.xy);
            else if (view == 7) return tex2D(_MainTex, float2(0.333,0.25) + float2(0.333, 0.25) * uv.xy);
            else if (view == 8) return tex2D(_MainTex, float2(0.666,0.25) + float2(0.333, 0.25) * uv.xy);

            else if (view == 9) return tex2D(_MainTex, float2(0.000,0.00) + float2(0.333, 0.25) * uv.xy);
            else if (view == 10) return tex2D(_MainTex, float2(0.333,0.00) + float2(0.333, 0.25) * uv.xy);
            else if (view == 11) return tex2D(_MainTex, float2(0.666,0.00) + float2(0.333, 0.25) * uv.xy);
            }
